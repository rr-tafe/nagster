# Nagster — Play Store listing copy

## App name (30 chars max)
Nagster

## Short description (80 chars max)
Reminders that keep nagging you until you confirm the task is actually done.
...
- Category: Utility/Productivity — answer "No" to all content questions → rating: Everyone
